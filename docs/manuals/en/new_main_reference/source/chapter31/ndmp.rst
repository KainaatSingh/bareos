...
.. limitation:: Limitation NDMP: File information are not available in the Bareos backup stream.


   .. index::

      triple: Limitation; NDMP; File information are not available in the Bareos backup stream
...
.. limitation:: Limitation NDMP\_NATIVE: Only use the first tape drive will be used.

   .. index::
      triple: Limitation; NDMP\_NATIVE; Only use the first tape drive will be used
...
.. limitation:: Limitation NDMP: A NDMP fileset should only contain a single File directive and Meta options.

   .. index::
      triple: Limitation; NDMP; A NDMP fileset should only contain a single File directive and Meta options
...
.. limitation:: Limitation NDMP: No single file restore on merged backups.

   .. index::
      triple: Limitation; NDMP; No single file restore on merged backups
...
.. limitation:: Limitation NDMP: 64-bit system recommended.

   .. index::
      triple: Limitation; NDMP; 64-bit system recommended
